...
abstract class AppLocalizations {
  ...
  /// No description provided for @dialogTitleAlert.
  ///
  /// In en, this message translates to:
  /// **'Alert'**
  String get dialogTitleAlert;
  ...
  ///
  /// In en, this message translates to:
  /// **'No servers found, please add one'**
  ...
  /// No description provided for @accountSelectionTitle.
  ///
  /// In en, this message translates to:
  /// **'Select Account'**
  String get accountSelectionTitle;

  /// No description provided for @accountListEmpty.
  ///
  /// In en, this message translates to:
  /// **'No accounts fond, please add one'**
  ...
  /// No description provided for @addAccountDialogDescription.
  ///
  /// In en, this message translates to:
